...
# ==== KONFIGURASI ====
LATITUDE = -7.3886    # Purbalingga
LONGITUDE = 109.3608  # Purbalingga
TIMEZONE = "Asia/Jakarta"
CALC_METHOD = 20  # Kementerian Agama Republik Indonesia (Aladhan API)
...
def test_kirim_paksa():
    print("Mengirim pesan test paksa ke Telegram...")
    resp = requests.post(
        f"https://api.telegram.org/bot{TELEGRAM_BOT_TOKEN}/sendMessage",
        json={
            "chat_id": TELEGRAM_CHAT_ID,
            "text": "✅ Test jalurnya jalan nih, Mal! Kalau bunyi berarti MacroDroid aman!",
        },
        timeout=15,
    )
...
if __name__ == "__main__":
    test_kirim_paksa()  # ← TEST MODE: aktif sekarang
    # main()            # ← PRODUCTION: aktif ini kalau test udah berhasil
